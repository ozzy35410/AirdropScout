...
export const NftFilters: React.FC<NftFiltersProps> = ({
  ...
  const hasActiveFilters = searchTerm || selectedTags.length > 0 || showMintedOnly || showUnmintedOnly;
        ...
        <div className="mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
          <div className="text-sm text-gray-600 dark:text-gray-400">
            ...
            {selectedTags.map((tag) => (
              <span key={tag} className="bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 px-2 py-1 rounded-md mr-2">
                {tag}
              </span>
            ))}
            {showMintedOnly && (
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
                     ...
                     focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
          >
            <option value="newest">{t('nft.sort.newest')}</option>
            <option value="az">{t('nft.sort.az')}</option>
            <option value="za">{t('nft.sort.za')}</option>
          </select>
        </div>
